...
class LodgedInNotice extends StatefulWidget {
  const LodgedInNotice({Key? key}) : super(key: key);

  @override
  State<LodgedInNotice> createState() => _LodgedInNoticeState();
}

class _LodgedInNoticeState extends State<LodgedInNotice> {
  int size = 0;
              ...
              builder: (context, provider, child) {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String name = data?.docs[index]["postTitle"];
                    if (name
                        .toLowerCase()
          ...
          Stack(
            children: [
              Text(
                ...
                style: TextStyle(
                    fontSize: 15.sp, height: 1.4, fontWeight: FontWeight.bold),
              ),
